...
Список текущих задач доступен в разделе Issues этого репозитория, если хотите присоединиться к команде ресурса и совершенствовать его постоянно, напишите об этом по адресу [frey@list.ru](mailto: frey@list.ru), вам датут доступ к организации проекта на Github.
